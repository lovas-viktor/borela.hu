...
export default function RfqPage() {
  return (
    <>
      ...
      <div className="py-12 bg-background border-b border-border">
        <div className="max-w-[880px] mx-auto px-7">
          ...
          <p className="text-[17px] text-ink-secondary leading-relaxed max-w-[560px] mb-6">
            Upload your drawing and get a meaningful answer within 2 business days — reviewed by an engineer, not an auto-responder.
          </p>
          {/* Hero trust */}
          <div className="flex flex-wrap gap-6">
            {[
              { label: "Response time", value: "2 business days" },
              { label: "Drawing required", value: "No — optional" },
              { label: "NDA available", value: "Yes — on request" },
            ].map((item) => (
      ...
      <section className="py-14 bg-surface border-y border-border">
        <div className="max-w-[1180px] mx-auto px-7">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { n: "01", title: "Technical drawing", desc: "STEP, IGES or PDF with all dimensions, tolerances and surface specifications." },
              { n: "02", title: "Material specification", desc: "Grade, hardness requirement, heat treatment requirement if any." },
              { n: "03", title: "Batch size", desc: "Per-delivery and annual volume estimate. Prototype quantities welcome." },
              { n: "04", title: "Target delivery date", desc: "First article or first series delivery. We'll confirm feasibility in our reply." },
            ].map((item) => (
              <div key={item.n}>
      ...
      <FAQAccordion label="Frequently asked questions" items={rfqFaqs} />
    </>
  );
}
